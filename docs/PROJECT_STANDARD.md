...
基础设施运行基线已完成，当前进入核心业务服务联调阶段。Seata Server 基线完成不等于 Seata AT 业务回滚完成。

1. 验证业务服务的 Nacos 配置加载；
2. 完成 User/Auth/Gateway 启动与注册；
3. 验证登录和 Gateway JWT；
4. 打通 Product/Inventory/Cart/Order；
5. 验证 Seata AT 真实回滚；
6. 打通支付与 RocketMQ；
7. 建立真实 Postman 集合；
8. 建立 JMeter 脚本和报告；
9. 完成 Sentinel、热更新和异常测试；
10. 整理答辩材料。
