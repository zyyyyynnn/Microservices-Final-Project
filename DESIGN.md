...
> 最后更新：2026-06-11
> 当前前端状态：视觉质量正在收口；首页 Hero 方向已确认，真实成功态截图和最终视觉验收仍待完成。
...
| 技术演示 | 无 | 游客 / 用户 | 技术能力通过真实业务链路与测试报告体现，不再设置单独前端技术演示页。 | 已清理 |
...
| 技术演示 | 无 | 技术能力通过真实业务链路与测试报告体现，不再设置单独前端技术演示页。 |
...
| 技术演示 | 无 | 技术能力通过真实业务链路与测试报告体现，不再设置单独前端技术演示页。 | 已清理 |
...
**2026-06-11 状态更新**：视觉质量正在收口；首页 Hero 方向已确认，真实成功态截图和最终视觉验收仍待完成。

## 布局宽度策略
- 首页采用居中内容画布，非超宽铺满设计。桌面端最大宽度控制在 1360～1440px；
- 首页 Hero 背景图是已确认的主视觉资产，不得在样式微调中替换。后续布局修复不得替换该背景图，也不得改变 background-image 实现方式。
